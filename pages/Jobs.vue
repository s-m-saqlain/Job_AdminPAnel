<template>
  <div>
    ...
    >
      <div
        class="h-full px-3 py-4 overflow-y-auto bg-[#1C2434] dark:bg-gray-800"
      >
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div>
          <div class="flex justify-end items-center">
            <div>
              ...
              <p v-if="profile">{{ profile.data.email }}</p>
            </div>
            <img
              v-if="profile && profile.data.profile"
              :src="profileImageUrl"
              alt="Profile Image"
            ...
            <div class="my-4">
              ...
              <div class="relative">
                <div
                  ...
                  id="suggestions"
                  :class="filteredJobs.length > 3 ? 'h-96 overflow-y-auto' : ''"
                  class="absolute bg-white border border-gray-200 mt-1 w-full"
                >
                  <div
      ...
      <p>{{ job.company_location }}</p> -->
            ...
            <div class="my-4">
              ...
              <div class="relative">
                <div
                  v-if="showSuggestionscity"
                  id="city"
                  :class="
                    filteredCities.length > 3 ? 'h-96 overflow-y-auto' : ''
                  "
                  class="absolute bg-white border border-gray-200 mt-1 w-full"
                >
                  <div
      ...
      <p>{{ job.company_location }}</p> -->
          ...
          >
            ...
            <div class="my-4">
              ...
              <div class="relative">
                <div
                  v-if="showSuggestionscompany"
                  id="company"
                  :class="
                    filteredCompany.length > 3 ? 'h-96 overflow-y-auto' : ''
                  "
                  class="absolute bg-white border border-gray-200 mt-1 w-full"
                >
                  <div
      ...
      <p>{{ job.company_location }}</p> -->
          ...
          <div v-if="loading" role="status" class="h-screen">
            <div class="flex justify-center items-center">
              <div class="pt-[12rem]">
                ...
                <span class="text-blue-500 text-2xl font-normal"
                  >Loading...</span
                >
              </div>
            </div>
          ...
          <div
            ...
            class="lg:grid lgrid-cols-1 md:grid-cols-2 gap-4"
          >
            <div
            ...
            >
              ...
              >
                ...
                <NuxtLink :to="{ path: '/jobdetail', query: { id: profile.id } }">
                  <div class="flex justify-center items-center">
                  <button
...
import UpdatePopup from "~/components/Update_Popup.vue";
import DeleteConfirmationPopup from "~/components/DeleteConfirmationPopup.vue";

const isPopupVisible1 = ref(false);
const selectedProfile = ref<Profile | null>(null);

const showDeletePopup = (profile: Profile) => {
