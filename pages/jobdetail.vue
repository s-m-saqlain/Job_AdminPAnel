      ...
      <div class="flex justify-end items-center">
        <div>
          <div class="flex justify-end items-center">
            <div>
              <p v-if="profile1">
                {{ profile1.data.fname }} {{ profile1.data.lname }}
              </p>
              <p v-if="profile">{{ profile1.data.email }}</p>
            </div>
            <img
              v-if="profile1 && profile1.data.profile"
              :src="profileImageUrl"
              alt="Profile Image"
            ...
            <div class="flex justify-between mx-6 mt-[2rem]">
              <div>
                ...
                <a
                  ...
                  href="https://uk.linkedin.com/company/mygwork?trk=public_jobs_topcard-org-name"
                  target="_blank"
                  >View Company</a
                >
              </div>
...
const profileImageUrl = computed(() => {
  return profile1.value && profile1.value.data.profile
    ? `${baseURL}${profile1.value.data.profile}`
    : "";
});
