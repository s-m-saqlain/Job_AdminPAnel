<template>
  <div v-if="visible" class="fixed inset-0 bg-gray-800 overflow-y-auto h-full">
    <div class="p-4">
      <div class="flex justify-end lg:mt-12 lg:mr-0 sm:mr-14">
        <svg
          @click="closePopup"
          ...
          class="text-white border rounded-full cursor-pointer"
        >
          <path d="M6 18L18 6M6 6l12 12"></path>
        </svg>
      </div>
      <h1 class="text-white text-center w-[700px] text-4xl font-medium">
        Update
      </h1>
      <!-- <p>Profile ID: {{ profileId }}</p> -->
      <!-- Add your popup content here -->
      <form @submit.prevent="handleSubmit" class="space-y-4 my-12">
        <div
          class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:w-[800px] sm:w-[400px] lg:mx-auto sm:mx-[300px]"
        >
          <div>
