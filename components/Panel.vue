        ...
        <ul class="space-y-2 font-medium">
          <div class="flex justify-between items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 sm:hidden" fill="none" viewBox="0 0 24 24"
              stroke="currentColor" @click="crosstoggleSidebar">
      ...
      <div class="flex justify-end items-center">
        <div>
          <div class="flex justify-end items-center">
            ...
            <img v-if="profile && profile.data.profile" :src="profileImageUrl" alt="Profile Image" class="h-20" />
            <!-- Display other profile details as needed -->
          </div>
        </div>
      </div>
      <Dashboard v-if="isDashboardVisible" />
      <Users v-if="isUsersVisible" />
      <Jobs v-if="isJobsVisible" />
      <Feedback v-if="isFeedbackVisible" />
