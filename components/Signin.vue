  ...
  <div class="lg:flex justify-center items-center gap-12 mt-12 lg:mx-0 sm:mx-6">
    ...
    <div class="lg:mt-0 sm:mt-[12rem] sm:mx-0 mx-4">
      ...
      <form @submit.prevent="login" class="my-12">
        <p>Email</p>
        <div class="flex justify-between items-center border border-gray-200 rounded-md mt-2">
          <input type="email" id="username" v-model="username" class="block w-[550px] sm:p-4 p-3 text-sm text-gray-900"
            placeholder="Enter Your Email" required />
          <svg class="fill-current mx-2" width="22" height="22" viewBox="0 0 22 22" fill="none"
        ...
        <div class="flex justify-between items-center border border-gray-200 rounded-md mt-2">
          <input type="password" id="search" v-model="password" class="block w-[550px] sm:p-4 p-3 text-sm text-gray-900"
            placeholder="6+ characters, 1 Capital Letter" required />
          <svg class="fill-current mx-2" width="22" height="22" viewBox="0 0 22 22" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.5">
              <path
        ...
        <div class="relative">
          ...
          <div class="flex justify-end items-center absolute inset-0 top-[18px]">
